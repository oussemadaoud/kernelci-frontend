...
require.config({
    ...
    map: {
        '*': {
            ...
            'app/view-releases-all': 'app/view-releases-all.2018.6.20',
            'app/view-releases-kernel': 'app/view-releases-kernel.2018.6.19', 
            'app/view-releases-kernel-board': 'app/view-releases-kernel-board.2018.6.19',
        }
    },
    shim: {
        'bootstrap': {
