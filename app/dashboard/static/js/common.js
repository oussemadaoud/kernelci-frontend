...
require.config({
    ...
    map: {
        '*': {
            ...
            'app/view-tests-all': 'app/view-tests-all.2017.7.30',
            'app/view-tests-board': 'app/view-tests-board.2017.7.30',
            'app/view-tests-board-job': 'app/view-tests-board-job.2017.7.30',
            'app/view-tests-board-job-kernel': 'app/view-tests-board-job-kernel.2017.7.30',
            'app/view-tests-suite-id': 'app/view-tests-suite-id.2017.7.30',
			...
			'app/view-releases-kernel-board-case-name': 'app/view-releases-kernel-board-case-name.2018.07.30',
        }
    },
    shim: {
        'bootstrap': {
